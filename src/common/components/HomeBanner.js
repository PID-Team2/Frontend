    ...
    <div className='home h-5/6 bg-fixed bg-no-repeat bg-center text-white flex justify-center items-center z-0'>
      <header className="m-0 flex justify-center">
        ...
        <div className="flex justify-center mt-60">
          {!authData.user &&
            <button className='rounded-lg bg-amber-400 px-4 py-3 text-md font-semibold text-white shadow-sm hover:bg-amber-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-amber-600'>
        ...
        <div className="flex absolute bottom-24  justify-center">
          <button onClick={() => scroll.scrollTo(580)} className="rounded-full bg-white py-2 px-4"><span className="text-zinc-850 font-bold text-xl" aria-hidden="true">&darr;</span></button>
        </div>
      </header>
    </div>
  );
